...
/*
 *  Introduced for FlashPro
 */
#ifdef _WINDOWS
	#pragma warning(disable: 4800)		// forcing value 'true' or 'false' (performance warning)
	#pragma warning(disable: 4333)		// forcing value to 0 by right shifting by a large amount
#endif
